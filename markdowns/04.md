...
Impure function it is no completely independent of outside state, due to this external call to non-constants we break the rules:
_Given the same inputs, always returns the same output_ 
_Produces no side-effects._
