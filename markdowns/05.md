...
VM1270:9 [{"id":1,"name":"Soda","price":"1.2","cost":1.04,"size":"4cl"},{"id":2,"name":"Beer","price":"3.0","cost":2.45,"size":"8cl"},{"id":3,"name":"Margarita","price":"5.0","cost":4.45,"size":"12cl"}]                   
```
...
const cats = [
  { name: 'Mojo',    months: 31 },
  { name: 'Mao-Mao', months: 9 },
  { name: 'Waffles', months: 88 },
  { name: 'Pickles', months: 36 }
]
...
Take advantage of all the language features, if you have something that it is already done and works re-use it, do not
spend time working on languague problem, focus on bussiness goal issues.
