...
function save(object){
    let newObject = {...object}; // clone it first :)
...
![Mutator_method](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/prototype#Mutator_methods Mutator_method "Mutator Methods list")
