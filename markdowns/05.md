...
## So, How can I use it? Let's start or continue doing these:

### * Arrow Functions (fat arrrow)
<p>
[ES6 Arrow functions](https://github.com/leolanese/ES6_workshop/blob/master/2.2-Arrow%20functions.md "Leo Lanese - ES6_workshop - The road to ECMAScript 6: New solutions for old JS problems.") create a concise expression that encapsulates a small piece of functionality. 
...
### lazy functions:  Controlling the side-effect: A side effect isn’t a side effect until it actually happens.
