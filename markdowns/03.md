...
> "Functional programming is a [**'declarative'**](#l-1) [**'paradigm'**](#l-2) of building software by [**'composing'**](#l-3) [**'pure functions'**](#l-31), avoiding [**'shared state'**](#l-4), [**'mutable data'**](#l-5) and [**'side-effects'**](#l-6). Placing the major emphasis on the use of functions; [**'abstracting control flows and operations on data with these functions and threaten them as building blocks'**](#l-7) by relying on [**'JS first-class'**](#l-8) and [**'higher-order functions'**](#l-9) 
