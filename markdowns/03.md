...
<p>
Composition means that we attach multiple functions together, in a chain, where the return value
of the first function becomes the input for the next function:
</p>


<p>
Composition f(g(x)) and Pipe are both function composition, 

* What is change is the order: Composition: evaluates `inside out, right to left = x, g and f`. Pipe: `evaluates outside in, left to right`.
* Pipe return the [Observable](https://github.com/ReactiveX/rxjs/blob/master/src/internal/Observable.ts "github rxjs Observable.ts") result of all of the operators having been called in the order they were passed in.

If you want to compose two functions you are forced to write your own compose function or use the already 
available ones in libraries such as [Lodash/fp](https://gist.github.com/jfmengels/6b973b69c491375117dc "Lodash/fp Docs") and [Ramda](https://ramdajs.com/docs/#compose "Ramda compose")
</p>

### Function Composition 
#### Are Compose and Pipe:
<p>
Composition f(g(h(x))) and Pipe are <strong>function composition</strong> 
</p>

** what is change is the order: Composition: Inside out, Pipe: Outside in. ** 
