...
- Compose and pipe are similar. What is change is the order: 
 ...
 + RxJS pipe method (rxjs/Rx 5.5+ pipeable operators) These operators are pure functions that can be used as standalone operators instead of methods on an observable.
 

[pipeable operator](https://github.com/ReactiveX/rxjs/tree/master/src/internal/operators "pipeable operators"). 
...
#### RxJS Pipe method example using TypeSsript

```javascript
// RxJS 5.5+ pipeable operators & Angular6+
...
// our custom pure functions operators
